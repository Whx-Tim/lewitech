    ...
    MobileCalendar.prototype = {
        init: function(params) {
            ...
            if (params.defaultDate) {
                var defaultArr = params.defaultDate.split('-');
                this.defaultY = ~~defaultArr[0];
                this.defaultM = ~~defaultArr[1];
                this.defaultD = ~~defaultArr[2];
            }
        ...
        bindEvent: function(type) {
            ...
            function dateCtrlInit() {
                var date = new Date();
                //设置默认日期
                date.setFullYear(_self.defaultY, (_self.defaultM-1), _self.defaultD);
                var dateArr = {
                    yy: date.getYear(),
                    mm: date.getMonth(),
                    dd: date.getDate() - 1
                ...
                // _self.gearDate.querySelector(".date_yy").setAttribute("val", 50);
                _self.gearDate.querySelector(".date_mm").setAttribute("val", dateArr.mm);
                _self.gearDate.querySelector(".date_dd").setAttribute("val", dateArr.dd);
                // _self.gearDate.querySelector(".date_yy").setAttribute("val", _self.defaultY);
                // _self.gearDate.querySelector(".date_mm").setAttribute("val", _self.defaultM);
                // _self.gearDate.querySelector(".date_dd").setAttribute("val", _self.defaultD);
                setDateGearTooth();
            }
            //呼出年月插件
            function popupYM(e) {
